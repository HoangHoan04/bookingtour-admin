...
import type { CreateTourDto, TourDto, UpdateTourDto } from "@/dto/tour.dto";
import { useRouter } from "@/routers/hooks";
import rootApiService from "@/services/api.service";
import { API_ENDPOINTS } from "@/services/endpoint";
import { useMutation, useQuery, useQueryClient } from "@tanstack/react-query";

export const usePaginationBooking = (
  params: PaginationDto<BookingFilterDto>,
) => {
  const { data, isLoading, refetch, error } = useQuery<
    PageResponse<BookingDto>
  >({
    queryKey: [API_ENDPOINTS.BOOKING.PAGINATION, params],
    queryFn: () =>
      rootApiService.post(API_ENDPOINTS.BOOKING.PAGINATION, params),
  });
...
// export const useBookingDetail = (id: string | undefined | null) => {
//   const { data, isLoading, refetch, error } = useQuery<BookingDto>({
//     queryKey: [API_ENDPOINTS.BOOKING.FIND_BY_ID, id],
//     queryFn: async () => {
//       const res = await rootApiService.post(API_ENDPOINTS.BOOKING.FIND_BY_ID, {
//         id,
//       });
